  ...
  >
    ...
    <motion.div className="col-span-1" variants={slideUpChild}>
      ...
      <div className="flex space-x-4">
        <Link href="#">
          <Image src="/images/twitter.png" alt="Twitter" width={20} height={20} priority />
        </Link>
        <Link href="#">
          <Image src="/images/linkedln.png" alt="LinkedIn" width={20} height={20} priority />
        </Link>
        <Link href="#">
          <Image src="/images/facebook.png" alt="Facebook" width={20} height={20} priority />
        </Link>
        <Link href="#">
          <Image src="/images/instagram.png" alt="Instagram" width={20} height={20} priority />
        </Link>
      </div>
    </motion.div>
    ...
    {/* Industries col 2 */}
    <motion.div variants={slideUpChild} className="space-y-2 sm:space-y-3">
      <h3 className="font-semibold mb-2 sm:mb-3 hidden sm:block">&nbsp;</h3>
    ...
    <motion.div variants={slideUpChild} className="space-y-2 sm:space-y-3">
      ...
      <ul className="space-y-1 sm:space-y-2 text-gray-600">
        {[
          ...
          { name: "Real Estate Agent", href: "/industries/real-estate-agent" },
