    ...
    <header className="w-full bg-white shadow-sm">
        ...
        <nav className="hidden lg:block">
          <ul className="flex items-center space-x-6 lg:space-x-8 text-sm font-medium">
            ...
            <li className="relative group">
              <Link href="/industries" className="text-[#00A7DE]">Industries</Link>
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-[500px] bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out delay-200 z-[100] grid grid-cols-2 gap-2 p-2">
                ...
                <ul>
                  ...
                  <li><Link href="/industries/orthopedic" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Orthopedic Specialist</Link></li>
                  <li><Link href="/industries/counselor" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Counselor</Link></li>
                  <li><Link href="/industries/optometrist" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Optometrist</Link></li>
                  <li><Link href="/industries/dietician" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Dietician</Link></li>
                  <li><Link href="/industries/gynecologist" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Gynecologist</Link></li>
                  <li><Link href="/industries/nurse" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Nurse</Link></li>
                  <li><Link href="/industries/occupational-therapist" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Occupational Therapist</Link></li>
                  <li><Link href="/industries/acupuncturist" className="block px-4 py-2 text-black hover:text-[#00A7DE]">Acupuncturist</Link></li>
                </ul>
              </div>
            </li>
      ...
      >
        ...
        <ul className="flex flex-col space-y-4 p-6 text-sm font-medium">
          <li><Link href="/" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Home</Link></li>
          <li><Link href="/features" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Features</Link></li>
          <li><Link href="/industries" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Industries</Link></li>
          <li><Link href="/pricing" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Pricing</Link></li>
          <li><Link href="/about" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>About</Link></li>
          <li><Link href="/contact" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Contact Us</Link></li>
          <li><Link href="/login" className="text-black hover:text-[#00A7DE]" onClick={() => setIsOpen(false)}>Log In</Link></li>
          <li>
            <Link
              href="/signup"
