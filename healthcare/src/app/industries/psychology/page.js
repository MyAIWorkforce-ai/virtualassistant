          ...
          <div className="relative z-10 flex flex-col md:flex-row pl-30 items-center justify-between px-8 py-16 border-b border-white">
            ...
            >
              ...
              <motion.p className="text-lg mb-6" variants={fadeUp}>
                ...
                <br /> by managing session bookings, reminders, progress
                <br /> notes, and follow-up care.{" "}
              </motion.p>
...
============================= */}
      ...
      >
        ...
        <motion.p
          ...
          variants={fadeUp}
        >
          Enhance therapeutic care with smart automation that saves time and
          keeps
          <br /> clients supported beyond sessions.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-[#797A7D] leading-relaxed">
              Ensures consistent follow-ups for
              <br /> ongoing mental health progress.
            </p>
          </motion.div>
...
========================== */}
      ...
      >
        ...
        <motion.div
          variants={stagger}
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 justify-items-center max-w-6xl w-full text-center"
        >
          {/* Card 1 */}
          <motion.div
            variants={fadeInUp}
          ...
          >
            ...
            <p className="text-sm">
              More patient engagement outside
              <br />
...
===================== */}
      ...
      <section className="px-4 py-12 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-[#797A7D] leading-relaxed">
            A patient managing anxiety schedules a therapy session through your
            virtual assistant
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            ...
            <motion.div variants={staggerChild}>
              ...
              <select className="w-full border border-[#D1D5DB] text-black placeholder-[#797A7D] rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#00A7DE]">
