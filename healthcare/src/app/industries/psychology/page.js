  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://virtual-assistant-website-aus-n7zq.vercel.app/industries/psychology" />
...
========================== */}
        ...
        >
          ...
          <motion.h2
            variants={fadeInUp}
            className="text-5xl md:text-5xl pb-9 font-bold mb-8 mt-4 text-center"
          >
            Productivity Gains
          </motion.h2>
          ...
          <motion.div
            variants={stagger}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 md:gap-y-12 gap-x-1 max-w-6xl w-full text-center"
          >
            {/* Card 1 */}
            <motion.div
              variants={fadeInUp}
