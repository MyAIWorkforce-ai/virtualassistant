        ...
        <section className="relative z-20 -mt-20 flex justify-center px-8">
          ...
          >
            ...
            >
              ...
              <p className="text-[#797A7D] text-sm text-center">
                Higher patient adherence to
                <br /> recovery exercises and care plans.
              </p>
            </motion.div>
          </motion.div>
        </section>
...
============================= */}
      ...
      >
        ...
        >
          ...
          reduces
          <br /> admin work, increases efficiency.
        </motion.p>
        ...
        >
          ...
          >
            <motion.img
              ...
              whileHover={{ scale: 1.2 }}
            />
            <h3 className="text-lg font-semibold">Reduced Workload</h3>
            <p className="text-sm">
