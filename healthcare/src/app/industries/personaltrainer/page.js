          ...
          <div className="relative z-10 flex flex-col md:flex-row pl-30 items-center justify-between px-8 py-16 border-b border-white">
            ...
            >
              ...
              <motion.p className="text-lg mb-6" variants={fadeUp}>
                Your virtual assistant streamlines fitness <br /> management by
                automating scheduling, progress
                <br /> tracking, reminders, and training notes.
              </motion.p>
        ...
        >
          ...
          >
            <motion.img
              ...
              whileHover={{ scale: 1.2 }}
            />
            <h3 className="text-lg font-semibold">Increased Attendance</h3>
            <p className="text-sm">
