          ...
          <div className="relative z-10 flex flex-col md:flex-row pl-30 items-center justify-between px-8 py-16 border-b border-white">
            ...
            >
              ...
              <motion.p className="text-lg mb-6" variants={fadeUp}>
                Your virtual assistant handles bookings, reminders,
                <br /> and notes, so you can focus on delivering care, not
                <br /> admin.
              </motion.p>
        ...
        <section className="relative z-20 -mt-20 flex justify-center px-8">
          ...
          >
            ...
            >
              ...
              <p className="text-[#797A7D] text-sm text-center">
                Follow-up tracking and <br />
                reminders help maintain regular
                <br /> sessions.
              </p>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-[#797A7D] leading-relaxed">
              ...
              <br /> follow-ups handled automatically, <br />
          ...
          >
            ...
            <p className="text-sm text-[#797A7D] leading-relaxed">
              Record massage details, focus areas,
          ...
          >
            ...
            <p className="text-sm text-[#797A7D] leading-relaxed">
              ...
              <br /> more time delivering relaxation
              <br /> and therapy.
            </p>
          </motion.div>
        </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#797A7D]">
                  Record personalized notes and monitor treatment effectiveness
                  over time.
                </p>
              </div>
            </motion.div>
          ...
          {[
            {
              ...
              text: (
                <>
                  {" "}
                  Confirms their appointments instantly with available <br />
                  time slots.
                </>
              ),
              bg: "bg-[#3B82F6]/8",
            ...
            },
            {
              ...
              text: (
                <>
                  Logs treatment updates after each session
                  <br /> automatically.
                </>
              ),
              bg: "bg-[#F5B80B]/8",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            ...
            <motion.div variants={staggerChild}>
              ...
              <select className="w-full border border-[#D1D5DB] text-black placeholder-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#00A7DE]">
