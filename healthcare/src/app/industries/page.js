...
export default function Home() {
  return (
    <>
      {/* ✅ SEO Meta Tags */}
      <Head>
        <title>Smart Scheduling for Every Industry | AI Booking Solutions</title>
        <meta
          name="description"
        ...
        />
        <meta name="keywords" content="AI scheduling, healthcare automation, smart booking, wellness scheduling software, appointment reminders" />
      ...
      >
        ...
        <header className="w-full bg-white shadow-lg">
          <div className="flex justify-between items-center h-[74px] max-w-[1440px] w-full mx-auto px-4 md:px-6">
            ...
            {/* Navigation */}
            <nav>
              <ul className="flex flex-wrap items-center gap-4 md:gap-8 text-sm font-medium">
                <li>
                  <Link href="/" className="text-black hover:text-[#00A7DE]">Home</Link>
                </li>
                <li>
                ...
                <li className="relative group">
                  <Link href="/industries" className="text-[#00A7DE] hover:text-[#00A7DE]">Industries</Link>
                  <ul
                    className="
                  ...
                  >
                    <li>
                      <Link href="/industries/physiotherapist" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Physiotherapist
                      </Link>
                    </li>
                    <li>
                      <Link href="/industries/myotherapist" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Myotherapist
                      </Link>
                    </li>
                    <li>
                      <Link href="/industries/personaltrainer" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Personal Trainer
                      </Link>
                    </li>
                    <li>
                      <Link href="/industries/massagetherapist" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Massage Therapist
                      </Link>
                    </li>
                    <li>
                      <Link href="/industries/psychology" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Psychology
                      </Link>
                    </li>
                    <li>
                      <Link href="/industries/chiropractor" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                        Chiropractor
                      </Link>
                    </li>
                  </ul>
                ...
                <li><Link href="/contact" className="text-black hover:text-[#00A7DE]">Contact Us</Link></li>
                <li><Link href="/login" className="text-black hover:text-[#00A7DE]">Log In</Link></li>
                <li>
                  <Link
                    href="/signup"
                    className="bg-[#00A7DE] text-white px-4 md:px-5 py-2 rounded-full font-semibold transition-all duration-300 ease-in-out hover:shadow-[0_0_15px_#00A7DE] hover:scale-105"
                  >
                    Sign Up
                  </Link>
                </li>
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold mb-4">
            <span className="text-black">Smart Scheduling <br /> for</span>{" "}
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Explore AI-powered scheduling solutions designed for healthcare and wellness professionals.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-sm text-[#797A7D] mt-4">{service.description}</p>

                <Link
                  href={`/industries/${service.title.toLowerCase().replace(/\s+/g, "")}`}
            ...
            >
              <div className="flex items-center gap-3">
                <Image
                  ...
                  height={64}
                />
                <h2 className="text-lg text-black font-semibold">Accountant</h2>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                <Image
                  ...
                  height={64}
                />
                <h2 className="text-lg text-black font-semibold">Consultant</h2>
              </div>
              <p className="text-gray-600 text-sm mt-3">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-9">
            ...
            >
              <div className="flex items-center gap-3">
                <Image
                  ...
                  height={64}
                />
                <h2 className="text-lg text-black font-semibold">Mechanic</h2>
              </div>
              <p className="text-[#797A7D] text-sm mt-3">
                Reliable auto repair and maintenance. Book mechanic services with
                easy scheduling, cancellations, and reminders.
              </p>
              <a
            ...
            >
              ...
              <p className="text-gray-600 text-sm mt-3">
                Trusted plumbing solutions for leaks, repairs, and installations.
                Get fast service with automated booking.
              </p>
              <a
