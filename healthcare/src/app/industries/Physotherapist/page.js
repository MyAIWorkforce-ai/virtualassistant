      ...
      <div className="min-h-screen flex flex-col">
        ...
        <header className="w-full bg-white shadow-sm">
          <div className="flex justify-between items-center h-[74px] max-w-[1440px] w-full mx-auto px-4 md:px-6 z-[100]">
            ...
            {/* Navigation */}
            <nav>
              <ul className="flex flex-wrap items-center space-x-4 md:space-x-8 text-sm font-medium">
                <li>
...
>
  ...
  <motion.p
    ...
    variants={fadeUp}
  >
    Streamline your practice with intelligent automation and patient care tools
  </motion.p>
  ...
  >
    ...
    >
      ...
      <p className="text-xs sm:text-sm text-[#797A7D] leading-relaxed">
        ...
        <br /> reminders, and follow-ups to keep <br /> your schedule organized.
      </p>
    </motion.article>
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-semibold mb-2">Secure Patient Records</h3>
      <p className="text-xs sm:text-sm text-[#797A7D] leading-relaxed">
        Secure storage of patient progress <br /> notes, treatment history, and exercise <br /> routines.
      </p>
    </motion.article>
    ...
    >
      ...
      <p className="text-xs sm:text-sm text-[#797A7D] leading-relaxed">
        Personalized scheduling for rehab <br /> plans and recurring therapy sessions.
      </p>
    </motion.article>
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-semibold mb-2">Better Adherence</h3>
      <p className="text-xs sm:text-sm text-[#797A7D] leading-relaxed">
        Fewer no-shows and better <br /> treatment adherence tracking for <br /> improved outcomes.
      </p>
    </motion.article>
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-semibold mb-2">Smooth Communication</h3>
      <p className="text-xs sm:text-sm text-[#797A7D] leading-relaxed">
        Seamless communication with <br /> patients about home exercises and <br /> care instructions.
      </p>
    </motion.article>
  </motion.div>
</motion.section>
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#797A7D]">
            Send automated reminders for upcoming physio sessions and appointments.
          </p>
        </div>
      </motion.article>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#797A7D]">
            Provide patients with personalized exercise routines and reminders.
          </p>
        </div>
      </motion.article>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#797A7D]">
            Sync with calendars to avoid overlapping bookings and conflicts.
          </p>
        </div>
      </motion.article>
    </div>
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#797A7D]">
            Track rehabilitation milestones and log patient progress digitally.
          </p>
        </div>
      </motion.article>
...
>
  ...
  >
    ...
    >
      ...
      />
      <h3 className="text-sm sm:text-base font-semibold">Time Savings</h3>
    ...
    >
      <motion.img
        ...
        whileHover={{ scale: 1.2 }}
      />
      <h3 className="text-sm sm:text-base font-semibold">Reduced Drop-offs</h3>
      <p className="text-xs sm:text-sm">
    ...
    >
      <motion.img
        ...
        whileHover={{ scale: 1.2 }}
      />
      <h3 className="text-sm sm:text-base font-semibold">Better Care</h3>
      <p className="text-xs sm:text-sm">
    ...
    >
      <motion.img
        ...
        whileHover={{ scale: 1.2 }}
      />
      <h3 className="text-sm sm:text-base font-semibold">More Face Time</h3>
      <p className="text-xs sm:text-sm">Get more face-to-face time with patients.</p>
    </motion.article>
  </motion.div>
</motion.section>
