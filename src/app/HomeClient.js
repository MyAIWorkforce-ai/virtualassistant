    ...
    <div className="p-2 sm:p-6 flex flex-col text-left flex-grow">
      ...
      {expanded && (
        <div className="mt-1 text-[#797A7D] text-sm">
          ...
          - One clean dashboard replaces multiple tools <span className="sm:ml-0 md:ml-2 lg:ml-2"> and </span> <span className="sm:ml-1 md:ml-0 lg:ml-0"> platforms.</span><br/>
          - Front-End Prompts, Easily update what your &nbsp;&nbsp; AI says to <span className="sm:ml-2 md:ml-0 lg:ml-0"> clients </span> on the phone, website, or <br/> &nbsp; chat — no tech skills required.<br/>
