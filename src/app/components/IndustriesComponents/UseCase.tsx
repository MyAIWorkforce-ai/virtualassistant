  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="rounded-[20px] p-6 md:p-8 text-black shadow-lg bg-gradient-to-br from-[#F9FAFB] to-[#F9FAFB] max-w-4xl mx-auto mb-10"
      >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center max-w-6xl mx-auto">
        {useCases.map((item, index) => (
          <motion.div
            key={index}
            whileHover={{ scale: 1.04, rotateZ: 1 }}
            transition={{ type: "spring", stiffness: 250, damping: 20 }}
            className={`w-full h-auto sm:w-[436px] sm:h-[116px] rounded-xl text-black shadow-md ${bgColors[index]} transition-transform mx-auto flex flex-col justify-between p-4`}
          >
