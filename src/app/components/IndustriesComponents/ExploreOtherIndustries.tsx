...
<section className="bg-[#F9FAFB] py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6 text-center">
    ...
    <motion.p
      ...
      className="text-gray-600 max-w-2xl mx-auto px-2 sm:px-0 mb-10"
    >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-2 sm:px-0">
      {nextIndustries.map((industry, index) => (
        <motion.div
          ...
          className="bg-white shadow-md rounded-2xl p-4 sm:p-6 text-left hover:shadow-lg transition-transform hover:scale-105
                     flex flex-col justify-between w-full min-h-[220px] sm:min-h-[auto] overflow-hidden"
        >
          ...
          <p className="text-[#797A7D] mb-4 break-words">
