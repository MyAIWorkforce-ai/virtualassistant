...
Your virtual assistant modernizes consulting by managing appointments, recording meeting notes, tracking project deadlines, sending follow-up reminders, and streamlining client communication.
                </motion.p>
            ...
            >
              ...
              >
                ...
                <p className="text-[#797A7D] text-base font-regular">
                  Fewer missed meetings and project deadlines with automated reminders.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-[#797A7D] text-base font-regular">
                 Reduced hours spent on scheduling, note-taking, and administrative tasks.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-[#797A7D] text-base font-regular">
                 Higher client satisfaction through consistent follow-ups and personalized care.
                </p>
              </motion.div>
            </motion.div>
          </section>
...
============================= */}
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
         Enhance your consulting practice with intelligent automation that reduces admin work, personalizes client service, and increases productivity.
          </motion.p>
...
Automatically manage client appointments, meetings, and deadlines without manual intervention. </p>
            </motion.article>
        ...
        Improved Client Care
              ...
              <p className="text-base font-regular text-[#797A7D] leading-relaxed">
Meeting notes, project updates, and client communications remain consistent and personalized.   </p>
            </motion.article>
            ...
            >
              ...
              <p className="text-base font-regular text-[#797A7D] leading-relaxed">
               AI manages routine follow-ups, reminders, and recurring tasks for efficient consulting service.
...
Regular check-ins, status updates, and personalized action plans help cultivate strong client relationships.
              </p>
            </motion.article>
            ...
            >
              ...
              <p className="text-base font-regular text-[#797A7D] leading-relaxed">
Easy access to past meeting notes, project files, and client records for seamless consulting.   </p>
            </motion.article>
          </motion.div>
        </motion.section>
...
Manage project workflows, client onboarding, meeting scheduling, and result tracking.
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-regular text-[#797A7D]">
               Support management, IT, HR, strategy, and compliance consulting with automated processes.
                  </p>
                </div>
              </motion.article>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-regular text-[#797A7D]">
               Automate recurring project reviews, client check-ins, and regular reporting.
                  </p>
                </div>
              </motion.article>
            </div>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-regular text-[#797A7D]">
               Log project status, deliverables, milestones, and follow-up actions for each client.
                  </p>
                </div>
              </motion.article>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-regular text-[#797A7D]">
                  Answer client inquiries, schedule meetings, and provide real-time support via AI assistant.
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm font-regular text-[#E0F2FE]">Save time by having AI schedule recurring client meetings and reminders.
 </p>
                    </motion.article>
...
Reduce missed deadlines and improve efficiency with AI-powered notifications.
                      </p>
                    </motion.article>
                    ...
                    >
                      ...
                      <p className="text-sm font-regular text-[#E0F2FE]">
                      Quickly access past meeting notes, files, and project details without manual searches.
                      </p>
                    </motion.article>
                  </motion.div>
                </motion.section>
        ...
        <section className="px-4 py-12 max-w-6xl mx-auto">
          ...
          >
            <h3 className="text-base font-semibold mb-2">
              Client Project Review & Action Plan
            </h3>
            <p className="text-sm font-regular text-[#797A7D] leading-relaxed">
A client schedules a review session and receives updates, reminders, and next steps through your virtual assistant.          </p>
          </motion.div>
  ...
  {[
    {
      ...
      text: (
        <>
          Clients receive automatic meeting confirmations and reminders.
        </>
      ),
      bg: "bg-[#3B82F6]/8",
    },
    {
      ...
      text: (
        <>
        Records project status, deliverables, and meeting outcomes for each client.
    ...
    },
    {
      ...
      text: (
        <>
          Automates scheduling of project reviews, progress check-ins, and feedback requests.
        </>
      ),
      bg: "bg-[#F5B80B]/8",
    },
